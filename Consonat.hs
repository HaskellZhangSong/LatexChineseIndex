module Consonat where

import Data.Char
chineseFirstConsonat = "ydkqsxnwzssxjbymgcczqpssqbycdscdqldylybssjgyqzjjfgcclzznwdwzjljpfyynnjjtmynzwzhflzppqhgccyynmjqyxxgd" ++
...
chineseCharacterStart , chineseCharacterCount :: Int
chineseCharacterStart = 19968
chineseCharacterCount = 20902

getChineseConsonat :: Char -> Char
getChineseConsonat c = let index = ord c - chineseCharacterStart in
      if index >= 0 && index <= chineseCharacterCount 
           then chineseFirstConsonat !! index
           else c
